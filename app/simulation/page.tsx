...
import { Gauge, Target, Trophy, Award, Lock, Plus, RefreshCw, ShoppingBag } from "lucide-react";
...
export default function SimulationDashboard() {
    ...
    // Scale 0-100 to coordinate points
        ...
        <div className="min-h-screen bg-slate-50 p-8 font-sans">
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex flex-col gap-2 mb-8">
                    ...
                    <p className="text-slate-500">Developer tools for balancing game economy and progression.</p>
                </div>
                            ...
                            <div className="grid grid-cols-4 sm:grid-cols-5 gap-4">
                                {badges.map(badge => (
                                    <button
                                        ...
                                        className={clsx(
                                            "aspect-square rounded-full flex items-center justify-center border-2 transition-all relative group",
                                            badge.isUnlocked
